...
from auth.valid_inputs import valid_password, valid_username
...
class Auth:
    ...
    def register_user(self, email: str, password: str) -> User:
        ...
        if not valid_password(password):
            raise ValueError("sorry we cannot allow that password")
        if not valid_username(email):
            raise ValueError("sorry we cannot allow that username")
        try:
